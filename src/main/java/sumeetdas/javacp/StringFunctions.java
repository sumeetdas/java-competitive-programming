...
public class StringFunctions {
     ...
     * 
     * link: https://https://en.wikipedia.org/wiki/Lexicographically_minimal_string_rotation
     * 
     * This function implements Duval's algorithm.
     * 
     * link: https://https://en.wikipedia.org/wiki/Lexicographically_minimal_string_rotation#Duval.27s_Lyndon_Factorization_Algorithm
     * 
     * Complexity: O(n)
     * 
     * @param text
    ...
    public static List<Integer> getPrefSufTable(String text) {
        ...
        final List<Integer> prefSufTable = new ArrayList<>();
