package sumeetdas.javacp.datastructures;
...
public class Matrix<T extends Number> {
    ...
    public Matrix<T> identity() throws Exception{
        ...
        final var element = this.get(0, 0);
        final T zero;
        final T one;
        ...
        final var array = (T[][])new Number[this.rows][this.cols];
        ...
        final var identityMatrix = new Matrix<T>(this.rows, this.cols, array);
        for(var i = 0; i < this.rows;++i){
